...
<div class="container">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        <img src="<c:url value="/resources/F2.jpg"/>" alt="F2" width="500" height="500">
      </div>

      <div class="item">
        <img src="<c:url value="/resources/F3.jpg"/>" alt="F3" width="200" height="100">
      </div>

      <div class="item">
        <img src="<c:url value="/resources/F4.jpg"/>" alt="F4" width="200" height="250">
      </div>
    </div>
